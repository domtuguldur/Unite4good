...
export {}
declare global {
  const CAT_COLOR: typeof import('../../stores/app').CAT_COLOR
  const COMPANIES: typeof import('../../stores/app').COMPANIES
  const SAMPLE_COMMENTS: typeof import('../../stores/app').SAMPLE_COMMENTS
  const VOLUNTEERS: typeof import('../../stores/app').VOLUNTEERS
  ...
  const useStars: typeof import('../../composables/useStars').useStars
...
declare global {
  ...
  // @ts-ignore
  export type { User, Program, Challenge, Comment } from '../../stores/app'
  import('../../stores/app')
}
...
declare module 'vue' {
  interface ComponentCustomProperties {
    readonly CAT_COLOR: UnwrapRef<typeof import('../../stores/app')['CAT_COLOR']>
    readonly COMPANIES: UnwrapRef<typeof import('../../stores/app')['COMPANIES']>
    readonly SAMPLE_COMMENTS: UnwrapRef<typeof import('../../stores/app')['SAMPLE_COMMENTS']>
    readonly VOLUNTEERS: UnwrapRef<typeof import('../../stores/app')['VOLUNTEERS']>
    ...
    readonly useStars: UnwrapRef<typeof import('../../composables/useStars')['useStars']>
